...
public class FaceUtil {
	...
	public static final BlockFace[] CARDINAL = {BlockFace.WEST, BlockFace.NORTH, BlockFace.EAST,  BlockFace.SOUTH};
	...
	public static BlockFace getDirection(final double dx, final double dz, boolean useSubCardinalDirections) {
		return yawToFace(MathUtils.getLookAtYaw(dx, dz), useSubCardinalDirections);
	}
	...
	public static int getFaceYawDifference(BlockFace face1, BlockFace face2) {
		return MathUtils.getAngleDifference(faceToYaw(face1), faceToYaw(face2));
	}
	...
	public static double cos(final BlockFace face) {
		switch (face) {
			case SOUTH_WEST:
			case NORTH_WEST:
				return -MathUtils.HALFROOTOFTWO;
			case SOUTH_EAST:
			case NORTH_EAST:
				return MathUtils.HALFROOTOFTWO;
			case EAST:
