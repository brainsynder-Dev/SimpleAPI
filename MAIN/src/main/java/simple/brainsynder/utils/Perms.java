...
public class Perms {
    ...
    public static final Permission.Validator TEXTUREGETTER_USE = new Permission.Validator("SimpleAPI.texturefinder.use");
    ...
    public static final Permission.Validator RENAME = new Permission.Validator("SimpleAPI.command.rename");
    public static final Permission.Validator HISTORY = new Permission.Validator("SimpleAPI.command.history");
}
